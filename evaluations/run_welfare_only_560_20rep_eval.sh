...
# Mirrors run_welfare_only_20rep_eval.sh (which targets checkpoint-1000) so the
# resulting welfare_only_560.json can be compared apples-to-apples against
# self_only_560.json and fair_only_560.json.
set -e
...
echo ""
echo "============================================"
echo "Welfare-only 560 20-rep eval complete!"
echo "============================================"
